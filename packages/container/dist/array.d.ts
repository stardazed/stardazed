...
export declare function setIndexedVec2(data: TypedArray, index: number, v2: MutFloat2): void;
export declare function copyVec2FromOffset(data: TypedArray, offset: number): MutFloat2;
export declare function setVec2AtOffset(data: TypedArray, offset: number, v2: MutFloat2): void;
...
export declare function setIndexedVec3(data: TypedArray, index: number, v3: MutFloat3): void;
export declare function copyVec3FromOffset(data: TypedArray, offset: number): MutFloat3;
export declare function setVec3AtOffset(data: TypedArray, offset: number, v3: MutFloat3): void;
...
export declare function setIndexedVec4(data: TypedArray, index: number, v4: MutFloat4): void;
export declare function copyVec4FromOffset(data: TypedArray, offset: number): MutFloat4;
export declare function setVec4AtOffset(data: TypedArray, offset: number, v4: MutFloat4): void;
...
export declare function setIndexedMat3(data: TypedArray, index: number, m3: MutFloat3x3): void;
...
export declare function setIndexedMat4(data: TypedArray, index: number, m4: MutFloat4x4): void;
