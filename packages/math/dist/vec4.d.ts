...
export declare function set(out: number[], x: number, y: number, z: number, w: number): number[];
export declare function set<T extends AN>(out: T, x: number, y: number, z: number, w: number): T;
...
export declare function random(out: number[], length: number): number[];
export declare function random<T extends AN>(out: T, length: number): T;
