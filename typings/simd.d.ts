...
declare namespace SIMD {
	...
	interface Float32x4Constructor{
		 ...
		 * @param t
		 */
		reciprocalApproximation(t: SIMD.Float32x4): SIMD.Float32x4;
		/**
		 * 
		 * @param a 
		 */
	...
	const Float32x4: Float32x4Constructor;
	/**
	...
	const Int32x4: Int32x4Constructor;
	/**
	...
	const Int16x8: Int16x8Constructor;
	/**
	...
	const Int8x16: Int8x16Constructor;
	/**
	...
	const Uint32x4: Uint32x4Constructor;
	/**
	...
	const Uint16x8: Uint16x8Constructor;
	/**
	...
	const Uint8x16: Uint8x16Constructor;
	/**
	...
	const Bool32x4: Bool32x4Constructor;
	/**
	...
	const Bool16x8: Bool16x8Constructor;
	/**
	...
	const Bool8x16: Bool8x16Constructor;
}
