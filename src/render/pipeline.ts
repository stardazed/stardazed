...
export class Pipeline {
	...
	private attrRoleIndexMap_: Map<VertexAttributeRole, number>;
	...
	constructor(private rc: RenderContext, desc: PipelineDescriptor) {
		...
		this.attrRoleIndexMap_ = new Map<VertexAttributeRole, number>();
	...
	set blendConstantAlpha(newAlpha: number) { this.blending_.constantColour[3] = clamp01(newAlpha); }
	...
	attributeIndexForRole(role: VertexAttributeRole) {
