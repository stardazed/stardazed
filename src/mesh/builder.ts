...
import { Float, Double } from "core/numeric";
import { TypedArray, ArrayOfNumber, appendArrayInPlace } from "core/array";
import { PrimitiveType, VertexField, VertexAttributeRole, vertexFieldElementCount, vertexFieldNumericType } from "mesh/types";
import { VertexBuffer, VertexBufferAttributeView, VertexAttribute, MeshData, IndexBuffer, minimumIndexElementTypeForVertexCount } from "mesh/meshdata";
...
export class MeshBuilder {
	...
	complete() {
		...
		const indexElemType = minimumIndexElementTypeForVertexCount(this.vertexCount_);
