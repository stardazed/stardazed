...
class JSONTransformer implements Transformer<string, JSONToken>, parse.JSONStreamParserDelegate {
	private parser: parse.JSONStreamParser;
	private controller!: TransformStreamDefaultController<JSONToken>;

	constructor() {
		this.parser = new parse.JSONStreamParser(this);
	}
