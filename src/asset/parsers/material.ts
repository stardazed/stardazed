...
namespace sd.asset {
	...
	export namespace parse {
		 ...
		 */
		function parseFloatArray(fx: any, len: number) {
		...
		function parseFloatValue(f: any) {
		...
		function getBaseColour(colour: Partial<MaterialColourMetadata>, def: Float3) {
		...
		function getSpecularFactor(colour: Partial<MaterialColourMetadata>, def: Float3) {
		...
		function getSpecularExponent(colour: Partial<MaterialColourMetadata>, def: number) {
		...
		function getMetallicFactor(colour: Partial<MaterialColourMetadata>, def: number) {
		...
		function getRoughnessFactor(colour: Partial<MaterialColourMetadata>, def: number) {
		...
		function getAlphaCoverage(meta: Partial<MaterialAssetMetadata>, def: AlphaCoverage) {
		...
		function getAlphaCutoff(meta: Partial<MaterialAssetMetadata>, def: number) {
		...
		function getAlphaFactor(meta: Partial<MaterialAssetMetadata>, def: number) {
		...
		function getHeightRange(meta: Partial<MaterialAssetMetadata>, def: number) {
		...
		function getEmissiveFactor(meta: Partial<MaterialAssetMetadata>, def: Float3) {
		...
		function getDoubleSided(meta: Partial<MaterialAssetMetadata>, def: boolean) {
		...
		function getUVScale(meta: Partial<MaterialAssetMetadata>, def: Float2) {
		...
		function getUVOffset(meta: Partial<MaterialAssetMetadata>, def: Float2) {
		...
		function validTexAssetOrFallback(asset: Asset<Texture2D> | undefined, original: Texture2D | undefined) {
			if (asset) {
